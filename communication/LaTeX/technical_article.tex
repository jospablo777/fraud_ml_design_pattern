...
\newcommand{\defn}[2][0pt]{\marginnote{\fcolorbox{accentteal!30}{accentteal!6}{\parbox{3.5cm}{\raggedright\small\sffamily\color{accentteal}\vspace{2pt}#2\vspace{2pt}}}}[#1]}
\usepackage{titlesec}
...
\usepackage[round,sort&compress]{natbib}\bibliographystyle{abbrvnat}
...
{\small\href{mailto:jospablo777@gmail.com}{jospablo777@gmail.com}\enspace$\cdot$\enspace\href{https://www.linkedin.com/in/jose-barrantes/}{linkedin.com/in/jose-barrantes}\par}\vspace{0.5em}
...
\defn{\textbf{Socio-technical system:} Behavior shaped by both technical components (models, pipelines, infrastructure) and human work (analyst review, organizational decisions, governance).}%
...
\defn[0.2cm]{\textbf{Label delay:} Ground truth is often confirmed only after complaints or investigations---incomplete at decision time.}%
...
\defn[0.2cm]{\textbf{Asymmetric error costs:} False negatives cause direct loss; false positives cause friction. Not interchangeable.}%
Third, error costs are asymmetric \citep{Bolton2002, HernandezAros2024}.

\defn[0.2cm]{\textbf{Time sensitivity:} A correct decision made too late may still be operationally poor.}%
...
\defn{\textbf{ML architecture patterns:} Washizaki et al.\ identified 33 ML patterns. Heiland et al.\ expanded to 70.}%
...
\defn{\textbf{HITL-ML family:} Active learning, interactive ML, machine teaching. Differs in \emph{how} and \emph{when} human expertise enters the loop.}%
\citet{MosqueiraRey2023} describe HITL-ML as a family of approaches.
...
\defn{\textbf{Open-set recognition:} Detecting cases outside any known class. Human review is most valuable at the boundary of model knowledge.}%
Expert-in-the-loop approaches suggest human review is most valuable where the model faces novelty \citep{Yuan2026}.

\defn{\textbf{Retrospective audit:} Review samples of automatically resolved cases to catch errors and revise routing logic.}%
